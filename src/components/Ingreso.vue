    ...
    export default {
        ...
        methods: {
            ...
            buscarCodigo(){
                ...
                axios.get('api/Articulos/BuscarCodigoIngreso/'+this.codigo)
                .then(response => {
            ...
            listarArticulo(){
                axios.get('api/Articulos/ListarIngreso/'+this.texto)
                    .then(response => {
            ...
            listar() {
                ...
                if (!this.search) {
                    ...
                    url = 'api/Ingresos/ListarFiltro/' + this.search;
                }
                axios.get(url)
                    .then(response => {
            ...
            listarDetalles(id){
                axios.get('api/Ingresos/ListarDetalles/' + id)
                    .then(response => {
            ...
            select() {
                axios.get('api/Personas/SelectProveedores').then( res => {
                    this.proveedores = res.data.map( proveedor => (
                        { text: proveedor.nombre, value: proveedor.idpersona }
                    ));
                }).catch(err => {
                    console.log(err)
                });
            ...
            desactivar(){
                axios.put('api/Ingresos/Anular/' + this.adId, {})
                    .then( response => {
                        this.adModal=0;
                        this.adAccion=0;
                        this.adNombre="";
