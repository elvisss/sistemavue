    ...
    export default {
        ...
        methods: {
            ...
            buscarCodigo(){
                ...
                axios.get('api/Articulos/BuscarCodigoVenta/'+this.codigo)
                .then(response => {
            ...
            listarArticulo(){
                axios.get('api/Articulos/ListarVenta/'+this.texto)
                    .then(response => {
            ...
            listar() {
                ...
                if (!this.search) {
                    ...
                    url = 'api/Ventas/ListarFiltro/' + this.search;
                }
                axios.get(url)
                    .then(response => {
            ...
            desactivar(){
                axios.put('api/Ventas/Anular/' + this.adId, {})
                    .then( response => {
                        this.adModal=0;
                        this.adAccion=0;
                        this.adNombre="";
